...
* `asset` asset in [UAI format](https://developer.trustwallet.com/developer/listing-new-assets/universal_asset_id)
...
* `from` asset in [UAI format](https://developer.trustwallet.com/developer/listing-new-assets/universal_asset_id)
* `to` asset in [UAI format](https://developer.trustwallet.com/developer/listing-new-assets/universal_asset_id)
