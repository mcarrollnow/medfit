...
- [**Database API 42501 errors**](https://supabase.com/docs/guides/troubleshooting/database-api-42501-errors) `401 42501`, `403 42501`
...
- [**Enabling the IPv4 add-on FAQ**](https://supabase.com/docs/guides/troubleshooting/enabling-ipv4-addon)
...
- [**How to delete Vercel linked projects**](https://supabase.com/docs/guides/troubleshooting/how-to-delete-vercel-linked-projects-9d08aa)
...
- [**Reload/refresh postgrest schema**](https://supabase.com/docs/guides/troubleshooting/refresh-postgrest-schema) `400 bad_request`
...
- [**Implementing soft deletes with supabase-js**](https://supabase.com/docs/guides/troubleshooting/soft-deletes-with-supabase-js)
