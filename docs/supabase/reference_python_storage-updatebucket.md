---
library: supabase
url: https://supabase.com/docs/reference/python/storage-updatebucket
...
### Install with PyPi [\#](https://supabase.com/docs/reference/python/storage-updatebucket\#install-with-pypi)
