...
However, it's important to note that certain [differences](https://supabase.com/docs/reference/self-hosting-analytics/introduction#differences) may arise due to the platform's infrastructure.
