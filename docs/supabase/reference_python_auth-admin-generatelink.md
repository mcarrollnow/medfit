---
library: supabase
url: https://supabase.com/docs/reference/python/auth-admin-generatelink
...
### Install with PyPi [\#](https://supabase.com/docs/reference/python/auth-admin-generatelink\#install-with-pypi)
