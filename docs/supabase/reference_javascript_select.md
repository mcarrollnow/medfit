...
### Install as package [\#](https://supabase.com/docs/reference/javascript/select\#install-as-package)
...
### Install via CDN [\#](https://supabase.com/docs/reference/javascript/select\#install-via-cdn)
...
### Use at runtime in Deno [\#](https://supabase.com/docs/reference/javascript/select\#use-at-runtime-in-deno)
...
## Generating TypeScript Types [\#](https://supabase.com/docs/reference/javascript/select\#generating-typescript-types)
...
## Using TypeScript type definitions [\#](https://supabase.com/docs/reference/javascript/select\#using-typescript-type-definitions)
...
### Response types for complex queries [\#](https://supabase.com/docs/reference/javascript/select\#response-types-for-complex-queries)
