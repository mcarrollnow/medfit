...
const  = await generateObject(),  }),  prompt: 'Generate a lasagna recipe.',});
...
``` ts
import  from '@ai-sdk/openai';import  from 'ai';import  from 'zod';
const  = await generateObject(),  prompt: 'Generate 3 hero descriptions for a fantasy role playing game.',});
```
...
(requestedDownloads: Array\<\>) =\> Promise\<Array\<null \| \>\>
