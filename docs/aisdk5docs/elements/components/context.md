...
``` tsx
import  from '@/components/ai-elements/context';
```
...
ComponentProps\<HoverCardContent\>
...
### [`<ContextContentHeader />`](#contextcontentheader-)
...
### [`<ContextContentFooter />`](#contextcontentfooter-)
