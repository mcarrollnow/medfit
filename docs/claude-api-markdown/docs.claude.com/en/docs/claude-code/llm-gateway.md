...
By default, the models will use those specified in [Model configuration](third-party-integrations.html#model-configuration). If you have configured custom model names in LiteLLM, set the aforementioned environment variables to those custom names. For more detailed information, refer to the [LiteLLM documentation](https://docs.litellm.ai/).
...
-   [Claude Code settings](settings.html)
-   [Enterprise network configuration](network-config.html)
-   [Third-party integrations overview](third-party-integrations.html)

Was this page helpful?

YesNo

[Network configuration](network-config.html)[Development containers](devcontainer.html)
