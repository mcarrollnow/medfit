...
This integration is built on top of the [Claude Code CLI and SDK](sdk/migration-guide.html), enabling programmatic use of Claude in your CI/CD jobs and custom automation workflows.
...
-   **API costs**:
    ...
    -   See [Anthropic pricing](../about-claude/pricing.html) for details
...
[GitHub Actions](github-actions.html)[Model Context Protocol (MCP)](mcp.html)
