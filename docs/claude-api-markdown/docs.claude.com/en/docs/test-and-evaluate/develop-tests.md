...
-   [
    ...
    ](strengthen-guardrails/reduce-latency.html)
...
-   [
    ...
    ](strengthen-guardrails/reduce-hallucinations.html)
-   [
    ...
    ](strengthen-guardrails/increase-consistency.html)
-   [
    ...
    ](strengthen-guardrails/mitigate-jailbreaks.html)
-   [
    ...
    ](strengthen-guardrails/handle-streaming-refusals.html)
-   [
    ...
    ](strengthen-guardrails/reduce-prompt-leak.html)
-   [
    ...
    ](strengthen-guardrails/keep-claude-in-character.html)
...
After defining your success criteria, the next step is designing evaluations to measure LLM performance against those criteria. This is a vital part of the prompt engineering cycle. ![](../../../../mintcdn.com/anthropic-claude-docs/LF5WV0SNF6oudpT5/images/how-to-prompt-eng%EF%B9%96fit=max&auto=format&n=LF5WV0SNF6oudpT5&q=85&s=72e3d1e26bc86aab09b6652a1b456407.png) This guide focuses on how to develop your test cases.
...
[Define success criteria](define-success.html)[Using the Evaluation Tool](eval-tool.html)
