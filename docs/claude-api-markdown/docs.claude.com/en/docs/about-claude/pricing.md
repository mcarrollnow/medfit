...
| Claude Sonnet 3.5 ([deprecated](model-deprecations.html)) | $3 / MTok | $3.75 / MTok | $6 / MTok | $0.30 / MTok | $15 / MTok |
| Claude Haiku 4.5 | $1 / MTok | $1.25 / MTok | $2 / MTok | $0.10 / MTok | $5 / MTok |
| Claude Haiku 3.5 | $0.80 / MTok | $1 / MTok | $1.6 / MTok | $0.08 / MTok | $4 / MTok |
| Claude Opus 3 ([deprecated](model-deprecations.html)) | $15 / MTok | $18.75 / MTok | $30 / MTok | $1.50 / MTok | $75 / MTok |
| Claude Haiku 3 | $0.25 / MTok | $0.30 / MTok | $0.50 / MTok | $0.03 / MTok | $1.25 / MTok |

MTok = Million tokens. The “Base Input Tokens” column shows standard input pricing, “Cache Writes” and “Cache Hits” are specific to [prompt caching](../build-with-claude/prompt-caching.html), and “Output Tokens” shows output pricing. Prompt caching offers both 5-minute (default) and 1-hour cache durations to optimize costs for different use cases.The table above reflects the following pricing multipliers for prompt caching:
...
Claude models are available on [AWS Bedrock](../../api/claude-on-amazon-bedrock.html) and [Google Vertex AI](../../api/claude-on-vertex-ai.html). For official pricing, visit:

-   [AWS Bedrock pricing](https://aws.amazon.com/bedrock/pricing/)
-   [Google Vertex AI pricing](https://cloud.google.com/vertex-ai/generative-ai/pricing)

**Regional endpoint pricing for Claude 4.5 models and beyond**Starting with Claude Sonnet 4.5 and Haiku 4.5, AWS Bedrock and Google Vertex AI offer two endpoint types:
...
-   [AWS Bedrock global vs regional endpoints](../../api/claude-on-amazon-bedrock.html#global-vs-regional-endpoints)
-   [Google Vertex AI global vs regional endpoints](../../api/claude-on-vertex-ai.html#global-vs-regional-endpoints)
...
| Claude Sonnet 3.5 ([deprecated](model-deprecations.html)) | $1.50 / MTok | $7.50 / MTok |
| Claude Haiku 4.5 | $0.50 / MTok | $2.50 / MTok |
| Claude Haiku 3.5 | $0.40 / MTok | $2 / MTok |
| Claude Opus 3 ([deprecated](model-deprecations.html)) | $7.50 / MTok | $37.50 / MTok |
| Claude Haiku 3 | $0.125 / MTok | $0.625 / MTok |

For more information about batch processing, see our [batch processing documentation](../build-with-claude/batch-processing.html).
...
When using Claude Sonnet 4 or Sonnet 4.5 with the [1M token context window enabled](../build-with-claude/context-windows.html#1m-token-context-window), requests that exceed 200K input tokens are automatically charged at premium long context rates:

The 1M token context window is currently in beta for organizations in [usage tier](../../api/rate-limits.html) 4 and organizations with custom rate limits. The 1M token context window is only available for Claude Sonnet 4 and Sonnet 4.5.
...
If the total exceeds 200,000 tokens, the entire request was billed at 1M context rates. For more information about the `usage` object, see the [API response documentation](../../api/messages.html#response-usage).
...
313 tokens |
| Claude Sonnet 3.5 (Oct) ([deprecated](model-deprecations.html)) | `auto`, `none`
...
313 tokens |
| Claude Sonnet 3.5 (June) ([deprecated](model-deprecations.html)) | `auto`, `none`
...
340 tokens |
| Claude Opus 3 ([deprecated](model-deprecations.html)) | `auto`, `none`
...
| `text_editor_20241022` (Claude Sonnet 3.5 ([deprecated](model-deprecations.html))) | 700 tokens |
...
Computer use follows the standard [tool use pricing](../agents-and-tools/tool-use/overview.html#pricing). When using the computer use tool: **System prompt overhead**: The computer use beta adds 466-499 tokens to the system prompt **Computer use tool token usage**:
...
-   Screenshot images (see [Vision pricing](../build-with-claude/vision.html))
...
For a detailed walkthrough of this calculation, see our [customer support agent guide](use-case-guides/customer-support-chat.html).
...
For a comprehensive guide on agent pricing patterns, see our [agent use cases guide](use-case-guides/overview.html).
...
For detailed rate limit information, see our [rate limits documentation](../../api/rate-limits.html). For higher rate limits or custom pricing arrangements, [contact our sales team](https://claude.com/contact-sales).
...
-   Enterprise customers can [contact sales](../../../cdn-cgi/l/email-protection.html#d0a3b1bcb5a390b1bea4b8a2bfa0b9b3feb3bfbd) for custom pricing
...
Contact our sales team at [\[email protected\]](../../../cdn-cgi/l/email-protection.html#bfccded3daccffded1cbd7cdd0cfd6dc91dcd0d2) or through the [Claude Console](https://console.anthropic.com/settings/limits) to discuss enterprise pricing options.
