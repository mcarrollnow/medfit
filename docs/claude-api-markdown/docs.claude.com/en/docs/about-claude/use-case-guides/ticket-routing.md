...
Work with your support team to [define clear success criteria](../../test-and-evaluate/define-success.html) with measurable benchmarks, thresholds, and goals. Here are some standard criteria and benchmarks when using LLMs for support ticket routing:
...
Try the [prompt generator](../../build-with-claude/prompt-engineering/prompt-generator.html) on the [Claude Console](https://console.anthropic.com/login) to have Claude write a first draft for you.
...
](https://github.com/anthropics/anthropic-cookbook/tree/main/capabilities/classification)[
...
[Overview](overview.html)[Customer support agent](customer-support-chat.html)
