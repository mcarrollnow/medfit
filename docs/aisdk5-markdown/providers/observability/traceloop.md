Observability Integrations: Traceloop
...
[Observability Integrations](../observability.html)Traceloop
...
Traceloop supports [AI SDK telemetry data](../../docs/ai-sdk-core/telemetry.html) through [OpenTelemetry](https://opentelemetry.io/docs/). You'll need to sign up at [https://app.traceloop.com](https://app.traceloop.com) and get an API Key.
