AI SDK Providers: Amazon Bedrock
...
[AI SDK Providers](../ai-sdk-providers.html)Amazon Bedrock

# [Amazon Bedrock Provider](#amazon-bedrock-provider)

The Amazon Bedrock provider for the [AI SDK](../../docs/introduction.html) contains language model support for the [Amazon Bedrock](https://aws.amazon.com/bedrock) APIs.
...
You can create models that call the Bedrock API [Bedrock API](https://docs.aws.amazon.com/bedrock/latest/userguide/titan-embedding-models.html) using the `.textEmbedding()` factory method.
