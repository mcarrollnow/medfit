AI SDK Errors: ToolCallRepairError
...
[AI SDK Errors](../ai-sdk-errors.html)ToolCallRepairError
...
](ai-too-many-embedding-values-for-call-error.html)

[Next

AI\_TypeValidationError

](ai-type-validation-error.html)
