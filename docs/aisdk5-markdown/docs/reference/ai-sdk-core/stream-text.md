...
[AI SDK Core](../../ai-sdk-core.html)streamText
...
A stream of partial outputs. It uses the \`experimental\_output\` specification. AsyncIterableStream is defined as AsyncIterable<T> & ReadableStream<T>.
...
](../../../cookbook/rsc/stream-text-with-chat-prompt.html)[
...
](../../../cookbook/node/stream-text-with-chat-prompt.html)
