...
[Advanced](../advanced.html)Multistep Interfaces
...
**Tool composition** is the process of combining multiple [tools](../ai-sdk-core/tools-and-tool-calling.html) to create a new tool. This is a powerful concept that allows you to break down complex tasks into smaller, more manageable steps.
