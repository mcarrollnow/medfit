Troubleshooting: Type Error with onToolCall
...
[Troubleshooting](../troubleshooting.html)Type Error with onToolCall
...
](use-chat-stale-body-data.html)

[Next

Model is not assignable to type "LanguageModelV1"

](model-is-not-assignable-to-type.html)
