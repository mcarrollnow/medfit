Troubleshooting: Server Actions in Client Components
...
[Troubleshooting](../troubleshooting.html)Server Actions in Client Components
...
](client-side-function-calls-not-invoked.html)

[Next

useChat/useCompletion stream output contains 0:... instead of text

](strange-stream-output.html)
