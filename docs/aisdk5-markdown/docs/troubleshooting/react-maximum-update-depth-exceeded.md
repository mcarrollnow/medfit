Troubleshooting: React error "Maximum update depth exceeded"
...
[Troubleshooting](../troubleshooting.html)React error "Maximum update depth exceeded"
...
](typescript-cannot-find-namespace-jsx.html)

[Next

Jest: cannot find module '@ai-sdk/rsc'

](jest-cannot-find-module-ai-rsc.html)
