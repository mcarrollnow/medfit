...
[Getting Started](../getting-started.html)Vue.js (Nuxt)
...
4.  The `streamText` function returns a [`StreamTextResult`](../reference/ai-sdk-core/stream-text.html#result). This result object contains the [`toDataStreamResponse`](../reference/ai-sdk-core/stream-text.html#to-data-stream-response) function which converts the result to a streamed response object.
