...
[Getting Started](../getting-started.html)Svelte
...
4.  The `streamText` function returns a [`StreamTextResult`](../reference/ai-sdk-core/stream-text.html#result-object). This result object contains the [`toUIMessageStreamResponse`](../reference/ai-sdk-core/stream-text.html#to-data-stream-response) function which converts the result to a streamed response object.
