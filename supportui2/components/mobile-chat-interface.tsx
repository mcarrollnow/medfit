...
import { Paperclip, Mic, Camera, Send, StopCircle, Moon, Sun, ChevronRight } from "lucide-react"
...
export function MobileChatInterface() {
  ...
  return (
    <div className="flex flex-col h-dvh w-full bg-background pt-16">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-card">
        <div className="flex items-center gap-3">
          <h1 className="font-semibold text-card-foreground">Customer Support - Admin Command Center</h1>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center px-6">
            <div className="w-20 h-20 flex items-center justify-center mb-4">{/* Removed logo */}</div>
