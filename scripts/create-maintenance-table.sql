...
DROP POLICY IF EXISTS "Allow public read of maintenance settings" ON maintenance_settings;
DROP POLICY IF EXISTS "Allow admin update of maintenance settings" ON maintenance_settings;
...
-- Allow authenticated users to update (admin check is done in app)
...
-- Success message
SELECT 'Maintenance settings table created successfully!' as message;
