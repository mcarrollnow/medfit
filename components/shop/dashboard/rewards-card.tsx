...
export function RewardsCard() {
  return (
    <div className="group relative overflow-hidden rounded-3xl border border-border bg-foreground/5 p-8 backdrop-blur-xl transition-all duration-500 hover:bg-foreground/10">
      ...
      <div className="relative z-10 flex flex-col justify-between gap-8 md:flex-row md:items-end">
        ...
        <div className="flex flex-col gap-4 md:items-end">
          <div className="rounded-2xl bg-foreground/5 px-6 py-4 backdrop-blur-md">
            <p className="text-sm text-foreground/60">Next Tier Status</p>
            <div className="mt-2 h-2 w-48 overflow-hidden rounded-full bg-foreground/10">
              <div className="h-full w-[70%] bg-white" />
            </div>
            <p className="mt-2 text-xs text-muted-foreground">550 points to Platinum</p>
          </div>
