...
export function EarningsChart({ earningsHistory }: EarningsChartProps) {
  return (
    <GrainyCard className="col-span-4 lg:col-span-3 h-full min-h-[400px]">
      <CardHeader>
        <CardTitle className="text-2xl font-light tracking-tight text-white">Earnings Overview</CardTitle>
        <CardDescription className="text-white/60">Your commission performance over the last 30 days.</CardDescription>
      </CardHeader>
