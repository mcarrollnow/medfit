      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-4xl font-bold tracking-tight text-white">Policy Editor</h1>
              <p className="text-lg text-white/50">Manage your legal and compliance documents</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            {selectedPolicy && (
              <a
                ...
                className="h-10 px-4 rounded-xl border border-white/10 bg-white/5 text-white hover:bg-white/10 transition flex items-center gap-2"
              >
            ...
            <Button
              ...
              className="h-10 px-6 rounded-xl bg-white text-black hover:bg-white/90 font-semibold disabled:opacity-50"
            >
              {saving ? (
                <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          >
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl">
              ...
              <div className="relative z-10 p-6">
                <h2 className="text-lg font-bold text-white mb-4">Policies</h2>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className={cn(
                            ...
                            selectedPolicy?.id === policy.id ? "bg-white/20" : "bg-white/10"
                          )}>
                            <Icon className="h-5 w-5" />
                          </div>
                          <div className="flex-1 min-w-0">
                            <p className="font-medium text-white truncate">{policy.title}</p>
                            <p className="text-xs text-white/50 truncate">{policy.subtitle}</p>
                          </div>
                          {policy.is_published ? (
                            <Eye className="h-4 w-4 text-green-400 shrink-0" />
                          ) : (
                            <EyeOff className="h-4 w-4 text-white/30 shrink-0" />
                          )}
                        </div>
                      </button>
                    )
          ...
          >
            {selectedPolicy ? (
                ...
                <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl">
                  ...
                  <div className="relative z-10 p-6 md:p-8 space-y-6">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-white/50">Page title, subtitle, and metadata</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-3">
                        <Label className="text-sm font-medium text-white/70">Hero Tagline</Label>
                        <Input
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            ...
                            className="h-12 pl-11 bg-white/5 border-white/10 text-white rounded-xl focus:border-white/30"
                          />
                        </div>
                      </div>
                      <div className="space-y-3">
                      ...
                      <div className="space-y-3">
                        <Label className="text-sm font-medium text-white/70">Last Updated</Label>
                        <div className="h-12 px-4 bg-white/5 border border-white/10 rounded-xl flex items-center text-white/50">
                  ...
                  <div className="relative z-10 p-6 md:p-8 space-y-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-white/50">{selectedPolicy.content.length} sections</p>
                      </div>
                    </div>
                        ...
                        >
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <p className="font-medium text-white">{section.title || `Section ${index + 1}`}</p>
                              <p className="text-xs text-white/50">Type: {section.type}</p>
                            </div>
                          ...
                          {expandedSections.has(section.id) && (
                            <div className="p-4 space-y-4 border-t border-white/10">
                              <div className="space-y-3">
                                <Label className="text-sm font-medium text-white/70">Section Title</Label>
                                <Input
                                  value={section.title || ''}
                                  onChange={(e) => updateSection(section.id, { title: e.target.value })}
                                  className="h-10 bg-white/5 border-white/10 text-white rounded-xl focus:border-white/30"
                                />
                              </div>
                              
                              {section.intro && (
                                <div className="space-y-3">
                                  <Label className="text-sm font-medium text-white/70">Introduction</Label>
                                  <Textarea
                                    value={section.intro || ''}
                                    onChange={(e) => updateSection(section.id, { intro: e.target.value })}
                                    className="min-h-[80px] bg-white/5 border-white/10 text-white rounded-xl focus:border-white/30"
                                  />
                                </div>
                              )}
                              ...
                              {section.content && (
                                <div className="space-y-3">
                                  ...
                                  <Textarea
                                    ...
                                    className="min-h-[120px] bg-white/5 border-white/10 text-white rounded-xl focus:border-white/30"
                                  />
                                </div>
                              )}
                              ...
                              {section.extra && (
                                <div className="space-y-3">
                                  <Label className="text-sm font-medium text-white/70">Additional Text</Label>
                                  <Textarea
                                    value={section.extra || ''}
                              ...
                              {section.footer && (
                                <div className="space-y-3">
                                  <Label className="text-sm font-medium text-white/70">Footer Note</Label>
                                  <Textarea
                                    value={section.footer || ''}
                                    onChange={(e) => updateSection(section.id, { footer: e.target.value })}
                                    className="min-h-[60px] bg-white/5 border-white/10 text-white rounded-xl focus:border-white/30"
                                  />
                                </div>
                              )}
                              ...
                              {section.items && Array.isArray(section.items) && (
                                <div className="space-y-3">
                                  <Label className="text-sm font-medium text-white/70">Items ({section.items.length})</Label>
                                  <div className="space-y-2 max-h-[300px] overflow-y-auto pr-2">
                                    {section.items.map((item: any, itemIndex: number) => (
                                      <div key={itemIndex} className="p-3 bg-white/5 rounded-lg border border-white/10 space-y-2">
                                        {item.label && (
                                          <Input
                                            value={item.label}
                                            onChange={(e) => {
                                            ...
                                            placeholder="Label"
                                            className="h-9 bg-white/5 border-white/10 text-white rounded-lg text-sm"
                                          />
                                        )}
                                        ...
                                        {item.text && (
                                          <Textarea
                                            ...
                                            className="min-h-[60px] bg-white/5 border-white/10 text-white rounded-lg text-sm"
                                          />
                                        )}
                                        {typeof item === 'string' && (
                                          <Input
                              ...
                              {section.columns && Array.isArray(section.columns) && (
                                <div className="space-y-3">
                                  <Label className="text-sm font-medium text-white/70">Columns</Label>
                                  <div className="grid md:grid-cols-2 gap-4">
                                    {section.columns.map((column: any, colIndex: number) => (
                                      <div key={colIndex} className="p-3 bg-white/5 rounded-lg border border-white/10 space-y-2">
                                        <Input
                                          value={column.title || ''}
                                          onChange={(e) => {
                                          ...
                                          className="h-9 bg-white/5 border-white/10 text-white rounded-lg text-sm font-medium"
                                        />
              ...
              <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-12 text-center">
                <div className="pointer-events-none absolute inset-0 bg-noise opacity-10" />
                <div className="relative z-10">
                  <FileText className="h-12 w-12 text-white/30 mx-auto mb-4" />
                  <p className="text-white/50">Select a policy to edit</p>
                </div>
              </div>
            )}
          </motion.div>
