  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-12">
          <div className="h-12 bg-white/10 rounded-lg w-96 animate-pulse mb-4" />
        ...
        <div className="rounded-2xl bg-white/5 border border-white/10 p-8 mb-10 animate-pulse">
        ...
        {/* Search */}
        <div className="mb-8">
          <div className="h-12 bg-white/10 rounded-xl w-full max-w-md animate-pulse" />
        </div>
