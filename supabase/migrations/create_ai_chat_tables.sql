-- AI Chat Sessions and Documents Tables
-- This migration creates tables for storing AI chat conversations, messages, and artifacts
...
CREATE TABLE IF NOT EXISTS documents (
  ...
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  title TEXT NOT NULL,
  kind TEXT NOT NULL, -- 'code', 'text', 'sheet', 'image'
  content TEXT,
...
CREATE INDEX IF NOT EXISTS idx_documents_session_id ON documents(chat_session_id);
